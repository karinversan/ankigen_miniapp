...
- Оценка качества карточек (`quality_score`): `59.800`
  Эта метрика собирается из четырёх факторов: сколько карточек удалось сгенерировать от запрошенного количества, у скольких карточек есть источник, насколько источники покрывают входные файлы и насколько вопросы уникальны.
